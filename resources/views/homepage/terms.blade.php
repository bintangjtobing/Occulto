@extends('welcome')
@section('title','Terms of service | Occulto')
...
<section>
    <div class="container">
        ...
        <p>Welcome to Occulto!</p>

        <p>These terms and conditions outline the rules and regulations for the use of Occulto's Website, located at
            https://occulto.site.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Occulto if
            you do not agree to take all of the terms and conditions stated on this page. Our Terms and Conditions were
            created with the help of the <a href="/">Terms And Conditions
                Generator</a> and the <a href="/">Free
        ...
        <p>We employ the use of cookies. By accessing Occulto, you agreed to use cookies in agreement with the Occulto's
            Privacy Policy.</p>
        ...
        <p>Unless otherwise stated, Occulto and/or its licensors own the intellectual property rights for all material
            on Occulto. All intellectual property rights are reserved. You may access this from Occulto for your own
            personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from Occulto</li>
            <li>Sell, rent or sub-license material from Occulto</li>
            <li>Reproduce, duplicate or copy material from Occulto</li>
            <li>Redistribute content from Occulto</li>
        </ul>

        <p>This Agreement shall begin on the date hereof.</p>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. Occulto does not filter, edit, publish or review Comments prior to their presence on
            the website. Comments do not reflect the views and opinions of Occulto,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, Occulto shall not be liable for the Comments or for any liability, damages or
        ...
        <p>Occulto reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Occulto a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            Occulto; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to Occulto. Please include your name, your organization name,
        ...
        <p>No use of Occulto's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
